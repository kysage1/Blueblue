...
# // Exporting URL Host
export Server_URL="raw.githubusercontent.com/hudaz4/Blueblue/main/test"
export Server1_URL="raw.githubusercontent.com/hudaz4/Blueblue/main/limit"
...
wget -q -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/hudaz4/Blueblue/main/nginx.conf" 
#mkdir -p /home/vps/public_html
wget -q -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/hudaz4/Blueblue/main/vps.conf"
