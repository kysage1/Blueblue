...
wget -q -O /usr/local/bin/ws-stunnel "https://raw.githubusercontent.com/hudaz4/Blueblue/main/ws-stunnel"
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/hudaz4/Blueblue/main/issue.net"
